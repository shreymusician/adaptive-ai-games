/**
 * Minimal in-memory fake of the MongoDB driver surface this package's
 * stores touch. Duplicated from @adaptive-ai/memory-engine's/
 * @adaptive-ai/player-modeling's own src/__tests__/fake-mongo.ts — same
 * rationale as this codebase's other peer-package duplications.
 */
