 ...
 * @adaptive-ai/memory-engine's and @adaptive-ai/player-modeling's logger.ts,
 * duplicated rather than shared per this codebase's established convention
 * for peer leaf packages.
 */
...
export const rootLogger = new Logger(new ConsoleLogSink(), { service: 'pattern-recognition' });
