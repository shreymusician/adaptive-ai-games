 ...
 * @adaptive-ai/memory-engine's / @adaptive-ai/event-pipeline's logger.ts,
 * duplicated rather than shared because these are peer leaf packages and a
 * shared-utils package isn't worth the indirection yet.
 */
...
export const rootLogger = new Logger(new ConsoleLogSink(), { service: 'orchestration' });
